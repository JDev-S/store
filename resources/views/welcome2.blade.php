...
<head>
    ...
    <link rel="stylesheet" href="/catalog/view/javascript/so_page_builder/css/style_render_243.css">
    ...
    <link href="https://opencart.opencartworks.com/themes/so_megastore/layout2/index.php?route=extension/amp/category&amp;path=25" rel="amphtml">
    <link href="https://opencart.opencartworks.com/themes/so_megastore/layout2/index.php?route=product/category&amp;path=25" rel="canonical">
    <link href="https://opencart.opencartworks.com/themes/so_megastore/layout2/image/catalog/forma-2.png" rel="icon">


    <link id="sdExtFontFamily" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
        ...
        <div class="container">
            <div class="header-top-left pull-left hidden-xs">
                <ul class="top-link list-inline">
                    ...
                    <li class="log login"><a class="link-lg" href="/iniciar_sesion ">Iniciar sesión </a>/<a href="/registrarse">Crear una cuenta</a></li>
                </ul>
            </div>
                                ...
                                <div class="shopcart">
                                   ...
                                   $query2 = "select sum(cantidad) as canti from carrito_compras where id_usuario=13 ";
                                    ...
                                    if(empty($cantidad) && empty($total))
                                    {
                                        ...
                                        <span class="items_cart">'.$cantidad[0]->canti.'</span>productos<span class="items_cart2"> item(s)</span><span class="items_carts"> $'.$total.' </span>
                                    </span>';
                                    }
                                    else
                                    {
                                    ...
                                    echo'<span class="total-shopping-cart cart-total-full">
                                        <span class="items_cart">0</span><span class="items_cart2">productos</span><span class="items_carts"> $0.00 </span>
                                    </span>';
                                    }
                                    ?>
                                </div>
                                            ...
                                            <div class="container">
                                                ...
                                                <ul class="megamenu" data-transition="slide" data-animationtime="300">
                                                    ...
                                                    <li class="item-vertical">
                                                        ...
                                                        <a href="/productos_categoria?categoria={{$categoria->id_categoria}}" class="clearfix">
                                                            <span>
                ...
                <div class="main-menu col-lg-9 col-md-9 col-sm-9">
                    ...
                    <script>
                        $(document).ready(function() {
                            $('a[href="https://opencart.opencartworks.com/themes/so_megastore/layout2/index.php?route=product/category&path=25"]').each(function() {
